...
def extract_images(data_path='../data/robot_parcours_1.avi'):
    """
    This function extract images from the video and save them in the folder input
                - Input : video 
                - Output : Images from video
    """
...
def load_data(plot_images=False): 
    """
    This function load the images form the input folder
                    - Input : if plot_images=True, display all images from the video
                    - Output: list of numpy array corresponding to the images form the video
    """
    images_path = '../input/'
...
def frames_to_video(inputpath, outputpath, fps): 
    """
    This function write the output video from all the processed images
                    - Input : path where processed images are stored, outputpath where the video is saved, FPS 
                    - Output : video
    """   
    image_array = []
