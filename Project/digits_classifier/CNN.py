...
class ConvNet(nn.Module):
    ...
    def __init__(self):
        ...
        # MLP 1 layer, 100 units : The output of the convolutional layer is reduce into a single vector of size 1024 -> 100 -> 10 through the MLP
    ...
    def forward(self, x):
        ...
        x = self.dropout(F.relu(self.fc1(x.view(-1, 1024))))
        x = self.fc2(x)
